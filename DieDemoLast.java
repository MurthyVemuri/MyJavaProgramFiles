...
class DieDemoLast {
	...
	public static void main(String[] args){
		...
		// DicePlayer dp1 = new DicePlayer("player 1", 0);
		// DicePlayer dp2 = new DicePlayer("player 2", 0);
		// DicePlayer dp3 = new DicePlayer("player 3", 0);
		// DicePlayer dp4 = new DicePlayer("player 4", 0);
